 ...
 * {@code cn.licry.mintcontrol.runtime.*} class bytes from this plugin's exact code
...
public final class ForgeBridgeManager {
    private static final String RUNTIME_PREFIX = "cn.licry.mintcontrol.runtime.";
    private static final String RUNTIME_PATH_PREFIX = "cn/licry/mintcontrol/runtime/";
    private static final String HOOK_CLASS = RUNTIME_PREFIX + "LaunchMintEventHook";
    ...
    private Map<String, byte[]> readOwnRuntimeBytecode() throws IOException {
        ...
        if (classes.isEmpty()) throw new IOException("No MintControl runtime bridge classes were found in own code source");
    ...
    public long getNativeMintEvents() { return longMetric("getNativeMintEvents"); }
