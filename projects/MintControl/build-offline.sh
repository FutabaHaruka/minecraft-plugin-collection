...
printf 'Manifest-Version: 1.0\nImplementation-Title: MintControl\nImplementation-Version: 1.0.0-rc17-p2\n\n' > "$BUILD/MANIFEST.MF"
jar cfm "$ROOT/MintControl-1.0.0-rc17-p2.jar" "$BUILD/MANIFEST.MF" -C "$BUILD/classes" .
echo "Built: $ROOT/MintControl-1.0.0-rc17-p2.jar"
